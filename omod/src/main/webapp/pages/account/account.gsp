...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("emr.task.accountManagement.label")}" , link: '${ui.pageLink("pihapps", "account/manageAccounts")}'},
...
<form method="post" id="accountForm" autocomplete="off">
    ...
    <div>
        <input type="button" class="cancel" value="${ ui.message("emr.cancel") }" onclick="javascript:window.location='/${ contextPath }/pihapps/account/manageAccounts.page'" />
