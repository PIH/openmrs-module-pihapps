<%  
  ...
  ui.includeJavascript("pihapps", "attachments/fragments/complexObsEncounterTemplate.js")
  
  ui.includeJavascript("uicommons", "services/obsService.js")
  ui.includeJavascript("pihapps", "attachments/directives/complexObsEncounterDirective.js")
%>
