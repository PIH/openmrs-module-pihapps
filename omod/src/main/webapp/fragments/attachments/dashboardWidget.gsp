<%
  ...
  ui.includeJavascript("pihapps", "attachments/app.js")
  ui.includeJavascript("pihapps", "attachments/dashboardWidget.js")
%>

<!-- Angular widgets -->
<%
  ui.includeFragment("pihapps", "attachments/dependenciesThumbnail")
  ui.includeFragment("pihapps", "attachments/dependenciesGallery")
%>
...
<% if (context.hasPrivilege("App: attachments.attachments.page")) { %>
    ...
    <a href="${ ui.pageLink("pihapps", "attachments/attachments", [patient: patient.patient.uuid, patientId: patient.id, returnUrl: ui.thisUrl()]) }">
