...
import static org.openmrs.module.pihapps.filter.TermsAndConditionsFilter.USER_PROPERTY_TERMS_AND_CONDITIONS_ACCEPTED_DATE;
...
public class TermsAndConditionsPageController {
    ...
    public String post(@RequestParam(value = "termsAndConditionsAccepted", defaultValue = "false") boolean termsAndConditionsAccepted,
        ...
        if (termsAndConditionsAccepted) {
            ...
            currentUser.setUserProperty(USER_PROPERTY_TERMS_AND_CONDITIONS_ACCEPTED_DATE, acceptanceDate);
