...
public class LabOrderRestController {
    ...
    public Object getLabOrders(HttpServletRequest request, HttpServletResponse response,
                               ...
                               @RequestParam(value = "activatedOnOrBefore", required = false) Date activatedOnOrBefore,
                               @RequestParam(value = "activatedOnOrAfter", required = false) Date activatedOnOrAfter,
        ...
        searchCriteria.setActivatedOnOrBefore(activatedOnOrBefore);
        searchCriteria.setActivatedOnOrAfter(activatedOnOrAfter);
